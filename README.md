# Docker container for Firefox (Always Latest)
[![Release](https://img.shields.io/github/release/Yakrel/docker-firefox.svg?logo=github&style=for-the-badge)](https://github.com/Yakrel/docker-firefox/releases/latest)
[![Docker Image Size](https://img.shields.io/docker/image-size/yakrel/firefox/latest?logo=docker&style=for-the-badge)](https://hub.docker.com/r/yakrel/firefox/tags)
[![Docker Pulls](https://img.shields.io/docker/pulls/yakrel/firefox?label=Pulls&logo=docker&style=for-the-badge)](https://hub.docker.com/r/yakrel/firefox)
[![Build Status](https://img.shields.io/github/actions/workflow/status/Yakrel/docker-firefox/docker-build.yml?logo=github&branch=main&style=for-the-badge)](https://github.com/Yakrel/docker-firefox/actions/workflows/docker-build.yml)
